...
/*
 * TODO: update with Gallery instructions
 */
	private void populateInstruction() {
		...
		galleryInstruction[2] = new Instruction("<html>Enter contact information.</html>", 
				true, new int[]{1,11,12,13,2}, "addContact", 2, false);
		
		galleryInstruction[3] = new Instruction("<html>Tap SAVE</html>", 
