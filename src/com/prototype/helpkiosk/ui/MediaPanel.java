...
//									Time stop = mediaPlayer.getStopTime();
//									System.out.println(stop);
//									mediaPlayer.setMediaTime(stop);
//									mediaPlayer.start();
...
//									mediaPlayer.start();
//
//									Time t = mediaPlayer.getDuration();
//									int i = 0;
//									while(mediaPlayer.getStopTime() == t) {
...
//								else if(evt.getClickCount() == 3 && !evt.isConsumed()){
//									Time stop = mediaPlayer.getStopTime();
//									mediaPlayer.setMediaTime(stop);
//									mediaPlayer.start();
//								}
